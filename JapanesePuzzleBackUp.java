...
public class JapanesePuzzleBackUp {
	...
	public static void main(String[] args) {
		...
		JapanesePuzzleBackUp jpSol = null;
		JapanesePuzzleBackUp jpSeq = null;
		...
		try { jpSol = JapanesePuzzleBackUp.createPuzzleFromSolutionInput(bis); }
		...
		try { jpSeq = JapanesePuzzleBackUp.createPuzzleFromSequences(bis); }
	...
	public static JapanesePuzzleBackUp createPuzzleFromSolutionInput(InputStream is) throws IOException {
	...
	public static JapanesePuzzleBackUp createPuzzleFromSolution(int[][] solution) {
	...
	public static JapanesePuzzleBackUp createPuzzleFromSolution(boolean[][] solution) {
		if (solution == null) throw new RuntimeException("ERROR: solution is null");
		if (solution.length == 0)  throw new RuntimeException("ERROR: solution has no rows (empty)!");
	...
	public static JapanesePuzzleBackUp createPuzzleFromSequences(InputStream is) throws IOException {
	...
	public static JapanesePuzzleBackUp createPuzzleFromSequences(String sequences) {
		...
		return new JapanesePuzzleBackUp(puzzleRowSequences, puzzleColSequences);
	}
...
*/
	...
	private JapanesePuzzleBackUp() { /* do not call */ }


	private JapanesePuzzleBackUp(int[][] rowSequences, int[][] colSequences) {
